...
<div class="col-sm-4">
<input type="email" name="emailid" class="form-control" mailformat = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;>
</div>
<label class="col-sm-2 control-label">Age<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="age" onKeyPress="return isNumberKey(event)" class="form-control" required  minlength="2" maxlength="2">
</div>
</div>
